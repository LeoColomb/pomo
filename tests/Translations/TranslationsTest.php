...
class TranslationsTest extends TestCase
{
    ...
    {
        $entry1 = new EntryTranslations(array('singular' => 'baba', 'translations' => array('babax')));
        $entry2 = new EntryTranslations(array('singular' => 'baba', 'translations' => array('babay'), 'context' => 'x'));
    ...
    {
        $entry_incomplete = new EntryTranslations(array('singular' => 'baba', 'plural' => 'babas', 'translations' => array('babax')));
        $entry_toomany = new EntryTranslations(array('singular' => 'wink', 'plural' => 'winks', 'translations' => array('winki', 'winka', 'winko')));
        $entry_2 = new EntryTranslations(array('singular' => 'dyado', 'plural' => 'dyados', 'translations' => array('dyadox', 'dyadoy')));
        $domain = new Translations();
    ...
    {
        $entry_digit_1 = new EntryTranslations(array('singular' => 1, 'translations' => array('1')));
        $entry_digit_2 = new EntryTranslations(array('singular' => 2, 'translations' => array('2')));
        $domain = new Translations();
